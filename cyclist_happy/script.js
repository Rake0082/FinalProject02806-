...
const STORY = {
    cyclist: [
        ...
        },
        {
            ...
            text:    'This analysis compares the frequency of each contributing factor against its fatality rate — separating what causes the most crashes from what makes them most deadly.<br><br>Alcohol Involvement has the highest fatality rate in the dataset at 1.89%, followed by Unsafe Speed at 0.84%. Together they account for fewer than 2,000 cyclist crashes in total. Driver Inattention, by contrast, is recorded in over 21,000 cyclist crashes — but carries a fatality rate of just 0.23%. Failure to Yield Right-of-Way follows a similar pattern: 9,000 incidents, 0.24% fatality rate. High volume, low lethality.<br><br>This distinction matters for prevention. Reducing the total number of crashes requires targeting the high-frequency, everyday errors — through better infrastructure and driver awareness. Eliminating fatalities requires targeting speed and impairment. Both problems are real, and both require their own response.',
        },
    ],
    pedestrian: [
        {

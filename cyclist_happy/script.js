    ...
    pedestrian: [
        {
            ...
            heading: 'The Rhythm of the Day',
            text:    'The data highlights two notable periods: a moderate increase during the morning hours around 08:00, and a more pronounced concentration in the late afternoon and early evening, peaking between 17:00 and 18:00. This pattern is closely tied to the rhythm of urban mobility — these hours correspond to the busiest periods on NYC streets, when the greatest number of pedestrians and vehicles share the same space. The higher frequency of collisions during the afternoon does not therefore indicate that the environment is inherently more dangerous at those hours; it reflects the increased volume of people in circulation simultaneously.',
        },
        {
        ...
        },
        {
            ...
            heading: 'What Makes a Crash Fatal?',
            text:    'This analysis identifies the primary factors that determine whether a pedestrian collision results in a fatality. The results reveal a combination of variables we can influence and those we cannot.<br><br>Age is the strongest predictor by a considerable margin. Older pedestrians face dramatically higher fatality rates — a reflection of physical vulnerability that no amount of behavioral caution can fully offset. Hour of day is the second most important factor, reinforcing the temporal pattern identified at the start: timing affects not only how many crashes happen, but how deadly they are.<br><br>Pedestrian action — what the person was doing at the moment of impact — ranks fifth, behind vehicle type and borough. This is a variable that sits at the intersection of individual behavior and infrastructure design: some actions that appear risky may reflect streets that are poorly adapted to how people actually move through them.',
        },
        {
        ...
        },
        {
            ...
            text:    'What a pedestrian is doing at the moment of impact has a measurable effect on survival. Crossing with the signal carries the lowest fatality rate of all recorded actions. Crossing against the signal raises it noticeably. Actions that place pedestrians in high-speed environments — such as walking along a roadway — carry the highest fatality rates by a significant margin.<br><br>These patterns sit at the intersection of individual behavior and infrastructure design. Some non-compliant actions occur frequently in specific locations — which raises the question of whether the behavior reflects poor choice or a street that is poorly adapted to how people actually move. A crossing point that requires a long detour will reliably produce jaywalking regardless of what the signal says.<br><br>This is precisely the kind of distinction that Vision Zero targets: separating the actions that are inherently dangerous from those that become dangerous because the infrastructure does not match pedestrian behavior.',
        },
        {
    ...
    motorist: [
        {
            ...
            heading: 'The Rhythm of the Day',
            text:    'The data highlights two notable periods: a concentration during the morning commute around 08:00, and a more pronounced peak in the late afternoon and early evening, between 17:00 and 18:00. This pattern closely follows the rhythm of urban traffic — these hours correspond to the busiest periods on NYC roads, when the greatest number of vehicles are in circulation. The higher frequency of collisions during these windows does not therefore indicate that driving is inherently more dangerous at those hours; it reflects the sheer volume of vehicles sharing the road simultaneously.',
        },
        {
            ...
            emotion: 'surprised',
            thought: 'More traffic, more crashes — but the afternoon carries more than its share.',
